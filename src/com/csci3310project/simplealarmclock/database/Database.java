package com.csci3310project.simplealarmclock.database;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_ALARM_TONE_TYPE = "alarm_tone_type";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_TONE_TYPE, alarm.getToneType().ordinal());
		cv.put(COLUMN_ALARM_TONE, alarm.getAlarmTonePath());
		cv.put(COLUMN_ALARM_MUSIC, alarm.getMusicPath());
	...
	public static Alarm getAlarm(int id) {
		...
		if(c.moveToFirst()){
			...
			alarm.setToneType(ToneType.values()[c.getInt(6)]);
			alarm.setAlarmTonePath(c.getString(7));
			alarm.setMusicPath(c.getString(8));
			alarm.setVibrate(c.getInt(9)==1);
			alarm.setAlarmName(c.getString(10));
		}
		c.close();
		return alarm;
	}
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( " 
				...
				+ COLUMN_ALARM_TONE_TYPE + " INTEGER NOT NULL, "
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				alarm.setToneType(ToneType.values()[cursor.getInt(5)]);
				alarm.setAlarmTonePath(cursor.getString(6));
				alarm.setMusicPath(cursor.getString(7));
				alarm.setVibrate(cursor.getInt(8) == 1);
				alarm.setAlarmName(cursor.getString(9));
